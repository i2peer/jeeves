...
void printState(int val) {
	switch(val) {
		case USB_STATE_DETACHED:
			Serial.print("USB_STATE_DETACHED\n");
			break;
		case USB_DETACHED_SUBSTATE_INITIALIZE:
			Serial.print("USB_DETACHED_SUBSTATE_INITIALIZE\n");
			break;
		case USB_DETACHED_SUBSTATE_WAIT_FOR_DEVICE:
			Serial.print("USB_DETACHED_SUBSTATE_WAIT_FOR_DEVICE\n");
			break;
		case USB_DETACHED_SUBSTATE_ILLEGAL:
			Serial.print("USB_DETACHED_SUBSTATE_ILLEGAL\n");
			break;
		case USB_ATTACHED_SUBSTATE_SETTLE:
			Serial.print("USB_ATTACHED_SUBSTATE_SETTLE\n");
			break;
		case USB_ATTACHED_SUBSTATE_RESET_DEVICE:
			Serial.print("USB_ATTACHED_SUBSTATE_RESET_DEVICE\n");
			break;
		case USB_ATTACHED_SUBSTATE_WAIT_RESET_COMPLETE:
			Serial.print("USB_ATTACHED_SUBSTATE_WAIT_RESET_COMPLETE\n");
			break;
		case USB_ATTACHED_SUBSTATE_WAIT_SOF:
			Serial.print("USB_ATTACHED_SUBSTATE_WAIT_SOF\n");
			break;
		case USB_ATTACHED_SUBSTATE_GET_DEVICE_DESCRIPTOR_SIZE:
			Serial.print("USB_ATTACHED_SUBSTATE_GET_DEVICE_DESCRIPTOR_SIZE\n");
			break;
		case USB_STATE_ADDRESSING:
			Serial.print("USB_STATE_ADDRESSING\n");
			break;
		case USB_STATE_CONFIGURING:
			Serial.print("USB_STATE_CONFIGURING\n");
			break;
		case USB_STATE_RUNNING:
			Serial.print("USB_STATE_RUNNING\n");
			break;
		case USB_STATE_ERROR:
			Serial.print("USB_STATE_ERROR\n");
			break;
		default:
			Serial.print("USB_STATE_UNKNOWN\n");
			break;
	}
}
...
bool AndroidAccessory::isConnected(void)
{
    ...
    max.Task();
    usb.Task();
	printState(usb.getUsbTaskState());
    if (!connected &&
